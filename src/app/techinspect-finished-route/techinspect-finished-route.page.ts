  ...
  //
      this.http.get('http://cf11.travelsoft.gr/itourapi/chrbus_vehicle_tech_inspect_add.cfm?' 
                    ...
                    + '&userid=dmta'
                      ...
                      setTimeout(() => {
                        loader.dismiss();
                        this.router.navigate(['routelist/' + JSON.stringify(this.dataFromStartedRouteWhileGoingBackDataWasTakenFromLoginPageTheDriverIdJSON) + '/' + JSON.stringify(this.dataFromStartedRouteWhileGoingBackDataWasTakenFromLoginPageTheDriverIdJSON)]);
                      }, 1000);
                    })
      }
      myData:any;
  ...
  // getFullYear(); 2020
     ...
     map(){
        ...
        setTimeout(() => {
          ...
          this.router.navigate(['routestarted/' + JSON.stringify(this.dataFromStartedRouteWhileGoingBackJSON) + '/' + JSON.stringify(this.dataFromStartedRouteWhileGoingBackJSON.ROUTE_ID)]);
        }, 1000);
